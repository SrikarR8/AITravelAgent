...
2.  **Level 2 (Interactive/Hover):** Increased shadow spread and a subtle lift.
3.  **Photography Depth:** Large images should have a subtle inner-glow or soft border radius to integrate them into the cream background.
